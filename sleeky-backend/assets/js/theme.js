...
$(document).ready(function () {
  ...
  if ($("body").hasClass("login")) {
    ...
    if (theme == "light") {
      ...
      $("#login").prepend(
        `<img class="login-logo" src="${url}/assets/img/ecs.png">`
      );
    }
  ...
  function handleNav() {
    ...
    // Add frontend link
    $("#admin_menu").append(
      '<li class="admin_menu_toplevel frontend_link"><a href="/"><i class="material-icons">arrow_back</i> Frontend Interface</a></li>'
    );
  ...
  $("p").each(function (index) {
    if (/Display/.test($(this).text()) || /Overall/.test($(this).text())) {
      ...
      var updated_content =
        "Running on" +
        content.slice(13, i) +
        '& <a href="https://sleeky.flynntes.com/" title="Sleeky">Sleeky</a>' +
        content.slice(i - 1);
